...
export const extractEmbeddedJson = (htmlSource, marker) => {
    // 1) Find marker and opening brace positions.
    // 2) Walk through characters with brace depth, string, and escape handling.
    // 3) Parse and return the first complete top-level JSON object.
